  ...
  return (
    <div className="bg-[#3B49DF] text-white rounded-lg p-8 mx-auto mt-4 shadow-2xl">
      <div className="flex items-center mb-6">
        ...
        <h1 className="text-2xl font-extrabold ml-4">You&apos;re now a part of the community!</h1>
      </div>
      ...
      <div className="space-y-4">
        ...
        <ActionButton emoji="✍️" text="Write your first DEV Community post" />
        <ActionButton emoji="🖌️" text="Customize your profile" />
        <ActionButton emoji="🚀" text="Join DEV++" />
      </div>
    </div>
  );
}